package alphaBank.logIn.filter;
...
import alphaBank.security.filters.AuthenticationFilter.WrappedRequest;
import alphaBank.security.model.AccountEntity;

@Service
@Order(10)
public class LoginFilter implements Filter {
	private static final String SECURITY_SERVICE_URL = "/alphaBank/security/";
	@Value("${app.data.provider.service.host:http://localhost:8895}")
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		restTemplate.exchange(dataProviderServiceHostAML + SECURITY_SERVICE_URL +"/", HttpMethod.GET, null, HttpServletResponse.class);
